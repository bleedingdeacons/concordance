 ...
 *
 *     Concordance/1.2.3 (rest@aa-bristol.org; https://aa-bristol.org)
 *
...
final class UserAgent
{
    ...
    {
        return self::forApp('Concordance', defined('CONCORDANCE_VERSION') ? CONCORDANCE_VERSION : '');
    }

    /**
     * Build the user-agent for one application.
     *
     * @param string $app     Product name, e.g. "Concordance".
